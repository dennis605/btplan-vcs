        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    LayoutCachedLeft =3060
                    LayoutCachedTop =2138
                    LayoutCachedWidth =6810
                    LayoutCachedHeight =2476
                    RowStart =3
                    RowEnd =3
                    ColumnStart =1
                    ColumnEnd =1
                ...
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4210752
                    Name ="txtVeranstaltungBemerkung"
                    ...
                    Begin
                        Begin Label
                            ...
                            Caption ="txtVeranstaltungBemerkung"
                            GroupTable =1
                            BottomPadding =150
                            GridlineColor =10921638
                            LayoutCachedLeft =338
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT tblVeranstaltung.idVeranstaltung, tblVeranstaltung.txtVeranstaltungName A"
                        "S Veranstaltung, tblVeranstaltung.dateVeranstaltungDatum AS Datum, tblVeranstalt"
                        "ung.dateVeranstaltungAnfang AS Beginn, tblVeranstaltung.dateVeranstaltungEnde AS"
                        " Ende, tblOrt.NameOrt AS Ort, tblOrt.NameOrt FROM tblVeranstaltung INNER JOIN tb"
                        "lOrt ON tblVeranstaltung.Veranstaltungsort = tblOrt.ID ORDER BY tblVeranstaltung"
                        ".txtVeranstaltungName; "
                    ColumnWidths ="0;2009;1442;1442;1442;1442"
                    GridlineColor =10921638
                    AfterUpdateEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Liste29\" xmlns=\"http://schemas.microsoft.com/office/access"
                                "services/2009/11/application\"><Statements><Action Name=\"SearchForRecord\"><Arg"
                                "ument Name=\"WhereCondition\">=\"["
                        End
                        Begin
                            Comment ="_AXL:idVeranstaltung] = \" &amp; Str(Nz(Screen.ActiveControl,0))</Argument></Act"
                    ...
                    Begin
                        Begin Label
                            ...
                            BorderColor =8355711
                            ForeColor =6710886
                            Name ="lstVeranstaltung_Bezeichnungsfeld"
                            Caption ="lstVeranstaltung"
                            GridlineColor =10921638
                ...
                Begin ComboBox
                    ...
                    ControlSource ="Veranstaltungsort"
                    RowSourceType ="Table/Query"
