            ...
            Begin
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Befehl8\" Event=\"OnClick\" xmlns=\"http://schemas.microsoft"
                                ".com/office/accessservices/2009/11/application\"><Statements><Action Name=\"OnEr"
                                "ror\"/><Action Name=\"SaveRecord\"/"
                        End
                        Begin
                            Comment ="_AXL:><ConditionalBlock><If><Condition>[MacroError]&lt;&gt;0</Condition><Stateme"
                                "nts><Action Name=\"MessageBox\"><Argument Name=\"Message\">=[MacroError].[Descri"
                                "ption]</Argument></Action><Action Name=\"RefreshRecord\"/></Statements></If></Co"
                                "nditionalBlock><Act"
                        End
                        Begin
                            Comment ="_AXL:ion Name=\"RunMenuCommand\"><Argument Name=\"Command\">Refresh</Argument></"
                                "Action></Statements></UserInterfaceMacro>"
                        End
                    End

                    LayoutCachedLeft =566
                    LayoutCachedTop =2182
                    LayoutCachedWidth =1346
                ...
                Begin CommandButton
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Befehl9\" Event=\"OnClick\" xmlns=\"http://schemas.microsoft"
                                ".com/office/accessservices/2009/11/application\"><Statements><Action Name=\"OnEr"
                                "ror\"/><Action Name=\"GoToRecord\">"
                        End
                        Begin
                            Comment ="_AXL:<Argument Name=\"Record\">New</Argument></Action><ConditionalBlock><If><Con"
                                "dition>[MacroError]&lt;&gt;0</Condition><Statements><Action Name=\"MessageBox\">"
                                "<Argument Name=\"Message\">=[MacroError].[Description]</Argument></Action></Stat"
                                "ements></If></Condi"
                        End
                        Begin
                            Comment ="_AXL:tionalBlock><Action Name=\"GoToControl\"><Argument Name=\"ControlName\">Nam"
                                "eOrt</Argument></Action></Statements></UserInterfaceMacro>"
                        End
                    End

                    LayoutCachedLeft =1757
                    LayoutCachedTop =2239
                    LayoutCachedWidth =2560
                    LayoutCachedHeight =2577
                    BackColor =14461583
                    BorderColor =14461583
                    HoverColor =15189940
                    PressedColor =9917743
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT [tblOrt].[ID], [tblOrt].[NameOrt] FROM tblOrt; "
                    ColumnWidths ="0;1440"
                    GridlineColor =10921638
                    AfterUpdateEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                "nterfaceMacro For=\"Kombinationsfeld17\" xmlns=\"http://schemas.microsoft.com/of"
                                "fice/accessservices/2009/11/application\"><Statements><Action Name=\"SearchForRe"
                                "cord\"><Argument Name=\"WhereCon"
                        End
                        Begin
                            Comment ="_AXL:dition\">=\"[ID] = \" &amp; Str(Nz(Screen.ActiveControl,0))</Argument></Act"
                    ...
                    Begin
                        Begin Label
                            ...
                            BorderColor =8355711
                            ForeColor =6710886
                            Name ="NameOrt1_Bezeichnungsfeld"
                            Caption ="Ort wählen"
                            GridlineColor =10921638
                            LayoutCachedTop =850
                    ...
                    OnClickEmMacro = Begin
                        ...
                        Begin
                            Comment ="_AXL:<?xml version=\"1.0\" encoding=\"UTF-16\" standalone=\"no\"?>\015\012<UserI"
                                ...
                                "ft.com/office/accessservices/2009/11/application\"><Statements><Action Collapsed"
                                "=\"true\" Name=\"OnError\"/><Action"
                        End
                        Begin
                            Comment ="_AXL: Name=\"GoToControl\"><Argument Name=\"ControlName\">=[Screen].[PreviousCon"
                                "trol].[Name]</Argument></Action><Action Name=\"ClearMacroError\"/><ConditionalBl"
                                "ock><If Collapsed=\"true\"><Condition>Not [Form].[NewRecord]</Condition><Stateme"
                                "nts><Action Name=\"Del"
                        End
                        Begin
                            Comment ="_AXL:eteRecord\"/></Statements></If></ConditionalBlock><ConditionalBlock><If Col"
                                "lapsed=\"true\"><Condition>[Form].[NewRecord] And Not [Form].[Dirty]</Condition>"
                                "<Statements><Action Name=\"Beep\"/></Statements></If></ConditionalBlock><Conditi"
                                "onalBlock><If Coll"
                        End
                        Begin
                            Comment ="_AXL:apsed=\"true\"><Condition>[Form].[NewRecord] And [Form].[Dirty]</Condition>"
                                "<Statements><Action Name=\"UndoRecord\"/></Statements></If></ConditionalBlock><C"
                                "onditionalBlock><If><Condition>[MacroError]&lt;&gt;0</Condition><Statements><Act"
                                "ion Name=\"Message"
                        End
                        Begin
                            Comment ="_AXL:Box\"><Argument Name=\"Message\">=[MacroError].[Description]</Argument></Ac"
                                "tion></Statements></If></ConditionalBlock><Action Name=\"RunMenuCommand\"><Argum"
                                "ent Name=\"Command\">Refresh</Argument></Action></Statements></UserInterfaceMacr"
                                "o>"
                        End
                    End
