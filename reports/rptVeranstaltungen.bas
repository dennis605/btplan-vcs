...
Begin Report
    ...
    ItemSuffix =69
    Filter ="idTagesplan = 1"
    RecSrcDt = Begin
        0xbca2e45ceec1e540
    End
    RecordSource ="qryVeranstaltungen"
        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    TabIndex =1
                    Name ="rptPersonal"
                    SourceObject ="Report.rptPersonal"
                    LinkChildFields ="frkVeranstaltung"
                    LinkMasterFields ="idVeranstaltung"

                    LayoutCachedTop =790
                    LayoutCachedWidth =5093
                    ...
                    Begin
                        Begin Label
                            ...
                            BorderColor =8355711
                            ForeColor =6710886
                            Name ="rptPersonal Beschriftung"
                            Caption ="Personal"
                            EventProcPrefix ="rptPersonal_Beschriftung"
                            LayoutCachedLeft =53
                            LayoutCachedTop =450
                ...
                Begin Subform
                    ...
                    TabIndex =2
                    Name ="subrptBewohner"
                    SourceObject ="Report.rptBewohner"
                    LinkChildFields ="frkVeranstaltung"
                    LinkMasterFields ="idVeranstaltung"
                    ...
                    Begin
                        Begin Label
                            ...
                            BorderColor =8355711
                            ForeColor =6710886
                            Name ="subrptBewohner Beschriftung"
                            Caption ="Bewohner"
                            EventProcPrefix ="subrptBewohner_Beschriftung"
